...
function checkEmailAvailability(email) {
  return fetch(`${window.BASE_URL}/api/users/checkEmailAvailability`, {
    method: "POST",
    credentials: "include",
...
fistForm.addEventListener("submit", async (e) => {
  ...
  try {
    const res = await fetch(`${window.BASE_URL}/api/users/signup`, {
      method: "POST",
      body: formData,
    });
...
secondForm.addEventListener("submit", async (e) => {
  ...
  try {
    const res = await fetch(`${window.BASE_URL}/api/users/signin`, {
      method: "POST",
      body: formData,
